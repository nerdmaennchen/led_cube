...
#define CREATE_FIFO_PUT_FCT(fifoType, fifoPrefix, fifoCnt) \
	static inline fifoPrefix ## _ErrorType_t fifoPrefix ##_put(const fifoType *i_data, fifoPrefix ##_fifoHandle_t *i_handle); \
	static inline fifoPrefix ## _ErrorType_t fifoPrefix ##_put(const fifoType *i_data, fifoPrefix ##_fifoHandle_t *i_handle) \
	{\
...
#define CREATE_FIFO_PEEK_FCT(fifoType, fifoPrefix, fifoCnt) \
	static inline fifoPrefix ## _ErrorType_t fifoPrefix ##_peek(const fifoPrefix ##_fifoHandle_t *i_handle,const  uint8_t i_index, fifoType *o_data); \
	static inline fifoPrefix ## _ErrorType_t fifoPrefix ##_peek(const fifoPrefix ##_fifoHandle_t *i_handle,const  uint8_t i_index, fifoType *o_data) \
	{\
...
#define CREATE_FIFO_GET_FCT(fifoType, fifoPrefix, fifoCnt) \
	static inline fifoPrefix ## _ErrorType_t fifoPrefix ##_get(fifoPrefix ##_fifoHandle_t *i_handle, fifoType *o_data) \
	{ \
		fifoPrefix ## _ErrorType_t error = fifoPrefix ## _FIFO_UNDERRUN; \
		GEN_FIFO_CLI_FUNCTION; \
...
#define CREATE_FIFO_GET_CNT_FCT(fifoType, fifoPrefix, fifoCnt) \
	static inline uint8_t fifoPrefix ##_getCount(const fifoPrefix ##_fifoHandle_t *i_handle); \
	static inline uint8_t fifoPrefix ##_getCount(const fifoPrefix ##_fifoHandle_t *i_handle) \
	{\
		uint8_t ret = 0U;\
		GEN_FIFO_CLI_FUNCTION;\
...
#define CREATE_FIFO_INIT_FCT(fifoType, fifoPrefix, fifoCnt) \
	static inline void fifoPrefix ##_init(fifoPrefix ##_fifoHandle_t *i_handle) \
	{\
		if (NULL != i_handle)\
		{\
			GEN_FIFO_CLI_FUNCTION;\
